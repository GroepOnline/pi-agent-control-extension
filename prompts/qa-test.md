...
---
Runtime note: install this package with `agy install .`; then invoke this as `/qa-test` and load `agy-agent-control`.
...
- **CLI command** (`agy`, `htop`, `my-cli --flag`) → terminal TUI
...
Use the **agy-agent-control** routing tables:
